...
const SHELTERS = [
  { id: 1, name: 'Windsor Arena',   coords: [42.3120, -83.0280], address: '445 Ouellette Ave', capacity: 850,  status: 'available' },
...
const ROUTE_TO_SHELTER = [
  [42.3149, -83.0364], [42.3145, -83.0350], [42.3138, -83.0320], [42.3120, -83.0280],
]
